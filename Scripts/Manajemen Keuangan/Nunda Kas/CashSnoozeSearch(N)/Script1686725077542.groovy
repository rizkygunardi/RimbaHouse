...
WebUI.click(findTestObject('Keuangan/Page_Menejemen Keuangan/a_Nunda Kas'))

WebUI.setText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/input_Generate Report_cari'), 'harisandri')

WebUI.click(findTestObject('Tambah anggota/Page_Menejemen Keuangan/button_Search'))

WebUI.getText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/div_Data Yang Anda Cari  Ditemukan'))
