...
WebUI.setText(findTestObject('Keuangan/Page_Menejemen Keuangan/input_Pengeluaran_nama'), book)

WebUI.setText(findTestObject('Keuangan/Page_Menejemen Keuangan/input_Harga_jumlah'), randomNumber.toString())

WebUI.setText(findTestObject('Keuangan/Page_Menejemen Keuangan/input_Tanggal Setor_tanggal'), '12098888')
