...
WebUI.uploadFile(findTestObject('Cek Profil/Page_Menejemen Keuangan/input_Ganti Foto Profile_pict'), '/Users/rizky/Downloads/p.JPG')

WebUI.click(findTestObject('Object Repository/Cek Profil/Page_Menejemen Keuangan/button_Update'))

WebUI.getText(findTestObject('Cek Profil/Page_Menejemen Keuangan/center_Update Profile Sukses'))
