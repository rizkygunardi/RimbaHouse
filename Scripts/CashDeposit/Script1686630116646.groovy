...
WebUI.click(findTestObject('Keuangan/Page_Menejemen Keuangan/a_Setor Kas'))

WebUI.selectOptionByIndex(findTestObject('Keuangan/Page_Menejemen Keuangan/select_Nama Anggota'), '1', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Keuangan/Page_Menejemen Keuangan/input_Uang Kas_jumlah'), randomNumber.toString())

WebUI.setText(findTestObject('Keuangan/Page_Menejemen Keuangan/input_Tanggal Setor_date'), todayDate)
