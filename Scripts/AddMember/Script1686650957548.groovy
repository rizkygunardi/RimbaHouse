...
String street = faker.address().fullAddress()

WebUI.openBrowser('')

WebUI.navigateToUrl('https://qatest.rimbahouse.com/login.php')

WebUI.click(findTestObject('Object Repository/Cek Profil/Page_Admin Login/div_Selamat Datang Admin                   _d8bbe6'))
...
WebUI.setText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/input_Nama Anggota_nama'), name)

WebUI.setText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/input_Alamat_alamat'), street)

WebUI.setText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/input_Tanggal Lahir_date'), '12011997')
