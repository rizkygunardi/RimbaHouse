...
WebUI.click(findTestObject('Tambah anggota/Page_Menejemen Keuangan/button_Detail'))

WebUI.getText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/div_Info Detail Anggota'))

WebUI.click(findTestObject('Tambah anggota/Page_Menejemen Keuangan/button_Kembali Lagi'))
