...
WebUI.setText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/input_Generate Report_cari'), 'laptopSamurai')

WebUI.click(findTestObject('Tambah anggota/Page_Menejemen Keuangan/button_Search'))

WebUI.getText(findTestObject('Tambah anggota/Page_Menejemen Keuangan/div_Yang Anda Cari Tidak Ditemukan'))
